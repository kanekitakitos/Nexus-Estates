\section{Arquitetura e Padrões de Projeto (Backend)}

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{Component Diagram.jpg}
    \caption{Diagrama de Componentes: Orquestração de microserviços, infraestrutura de dados e integrações externas.}
