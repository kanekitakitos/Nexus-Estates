...
\subsection{Configuração por variáveis de ambiente (compose standalone)}
Para simplificar o deploy e permitir correr o compose sem dependências locais, as variáveis de ambiente estão embutidas no próprio \texttt{docker-compose.deploy.yml}. Estas variáveis:
\begin{itemize}[nosep]
