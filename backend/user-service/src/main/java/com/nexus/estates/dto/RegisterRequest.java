...
public class RegisterRequest {
    ...
    /**
     * O endereço de email que servirá como credencial principal (login)
     */
    ...
    /**
     * A password de acesso escolhida pelo utilizador em texto limpo
     * Será intercetada e encriptada pelo serviço antes da persistência
     */
    ...
    /**
     * O número de telemóvel para contacto principal da conta
     */
    ...
    /**
     * O níveld e privilégio (Role) atribuído á nova conta
     */
