...
VALUES 
    ('Modern Loft in Downtown', '{"pt": "Loft moderno no centro com vista para a cidade.", "en": "Modern loft in downtown with city views."}', 'Downtown', 'Lisboa', 'Rua da Prata, 123', 250.00, 2, true, 'https://res.cloudinary.com/dsfjm1ncn/image/upload/v1777626895/2eb5b8ad-0b32-410e-98e1-311b8c81bf33_k83xkn.avif'),
    ('Cozy Mountain Cabin', '{"pt": "Cabine acolhedora na montanha, perfeita para o inverno.", "en": "Cozy mountain cabin, perfect for winter."}', 'Serra da Estrela', 'Covilhã', 'Caminho das Neves, 45', 450.00, 6, true, 'https://res.cloudinary.com/dsfjm1ncn/image/upload/v1777626894/80e44391-928d-4645-baad-b7530fdcd3d5_lxa34f.avif'),
    ('Seaside Villa with Pool', '{"pt": "Villa à beira-mar com piscina privada e acesso à praia.", "en": "Seaside villa with private pool and beach access."}', 'Algarve', 'Lagos', 'Avenida da Praia, 78', 1200.00, 10, true, 'https://res.cloudinary.com/dsfjm1ncn/image/upload/v1777626895/a709572e-f938-41f4-8de0-41840322972a_opb1b2.avif');
