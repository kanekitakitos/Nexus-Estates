...
export function ChatCompactSidebar({ initialChatId, launchNonce }: { initialChatId?: string; launchNonce?: number }) {
  ...
  return (
    <div className="flex min-h-0 flex-col h-full">
      ...
      {!selectedChatId ? (
        <div className="flex-1 min-h-0 overflow-y-auto animate-slide-in-left">
        ...
        <div key={selectedChatId} className="flex-1 min-h-0 overflow-hidden animate-slide-in-right">
