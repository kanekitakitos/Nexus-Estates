  ...
  return (
      <div className="relative w-full h-full flex flex-col justify-center pl-12 pr-10 md:pr-40 pt-16 overflow-hidden">
        ...
        <motion.div initial={{ opacity:0, x:-16 }} animate={{ opacity:1, x:0 }}
                    transition={{ delay:0.15 }} className="flex items-center gap-3 mb-6 relative z-20">
          <motion.span className="w-7 h-[1px]" style={{ background:`${B.black}28` }} />
          <span className="font-mono text-[9px] uppercase tracking-[0.32em]" style={{ color:`${B.black}65` }}>
        ...
        <motion.div className="flex items-center gap-6 relative z-20"
                    initial={{ opacity:0, y:16 }} animate={{ opacity:1, y:0 }}
                    transition={{ delay:1.1 }}>
          <motion.div className="flex items-center gap-2"
                      animate={{ x:[0,6,0] }} transition={{ duration:1.6, repeat:Infinity, ease:"easeInOut" }}>
          <span className="font-mono text-[10px] uppercase tracking-widest" style={{ color:`${B.black}50` }}>
            Faz Scroll
          </span>
            <motion.span style={{ color:`${B.black}50` }} className="text-sm">››</motion.span>
          </motion.div>
        </motion.div>
      </div>
  )
