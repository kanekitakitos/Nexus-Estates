...
export function PropertyEditForm({propertyState,  onClose, open} :
        {propertyState: [BookingProperty, Dispatch<SetStateAction<BookingProperty>>] ,
    ...
    const [propertyConcrete, setPropertyConcrete] = useState<BookingProperty>(propertySaved);

    // contexto a ser enviado ás componetes filhos
    const context : PropertyEditContext ={
